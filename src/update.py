...
if __name__ == "__main__":
    ...
    bj_update_hours = 24 * (bj_end_date - beijing_starttime).days + 1 + bj_end_date.hour - beijing_starttime.hour
    ...
    ld_update_hours = 24 * (ld_end_date - london_starttime).days + 1 + ld_end_date.hour - london_starttime.hour
